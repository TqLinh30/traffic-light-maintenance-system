...
<h1 align="center">SignalCare</h1>

[SignalCare](https://github.com/grashjs/cmms) is a powerful, self-hosted maintenance management system designed for both
...
2. Run:
   ...
   docker-compose up -d
   ```
Go to http://localhost:3000 to access SignalCare. 
...
| LICENSE_KEY                 | No       | [SignalCare license key](https://atlas-cmms.com/pricing?type=selfhosted) to get access to advanced features.                                                                                                                                                                                                | (empty)               |
...
- Open your configured `PUBLIC_FRONT_URL` in the browser to access SignalCare.
