const ruJSON = {
  ...
  'free_cmms.title': 'Бесплатное программное обеспечение SignalCare | Кредитная карта не требуется',
  ...
  'overview.description':
    'SignalCare — это бесплатная CMMS с открытым исходным кодом для управления заказами на работу, профилактическим обслуживанием, активами и объектами. Оптимизируйте операции технического обслуживания уже сегодня.',
  'overview.keywords':
    'CMMS, компьютеризированная система управления техническим обслуживанием, EAM, управление активами предприятия, cmms с открытым исходным кодом, бесплатное программное обеспечение для технического обслуживания, управление заказами на работу, профилактическое обслуживание, отслеживание активов, управление объектами, программное обеспечение для отслеживания технического обслуживания, обслуживание оборудования, SignalCare',
  'pricing.title': 'Цены - SignalCare',
  'pricing.description':
    'Гибкие тарифные планы для SignalCare. Выбирайте между облачной и самостоятельной версиями нашей CMMS с открытым исходным кодом, чтобы оптимизировать операции технического обслуживания.',
