const locale = {
  ...
  qr_code_not_found: 'This QR code is invalid or no longer available.',
  qr_code_disabled: 'This QR code is no longer active.',
  qr_code_not_available: 'QR code has not been generated yet.',
  ...
  traffic_light_service: 'Traffic Light Service',
  ...
  traffic_light_map: 'Traffic Light Map',
  district: 'District',
  all_statuses: 'All statuses',
  all_districts: 'All districts',
  no_traffic_light_points: 'No traffic light points match the current filters.',
  ...
  view_point_details: 'View point details',
  ...
  capturing_location: 'Trying to capture your current location.',
  location_captured: 'Your current device location has been captured.',
  location_unavailable:
    'Current device location is unavailable. You can still submit the request.',
