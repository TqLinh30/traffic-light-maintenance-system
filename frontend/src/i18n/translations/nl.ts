const locale = {
  ...
  key_features_description:
    'Enkele van de functies die SignalCare tot een van de beste CMMS van vandaag maken',
  ...
  'free_cmms.title': 'SignalCare Gratis CMMS Software | Geen creditcard nodig',
  ...
  'pricing.title': 'Prijzen - SignalCare',
  'pricing.description':
