const locale = {
  ...
  'free_cmms.title': 'SignalCare 免费 CMMS 软件 | 无需信用卡',
  'free_cmms.description': '免费 CMMS 软件 —— 并非试用版。立即管理维护、资产和工单。无需信用卡。',
  'free_cmms.keywords': '免费 cmms, 维护管理软件, 免费工单软件, 资产跟踪, 预防性维护',
  'overview.description': 'SignalCare 是一款免费、开源的 CMMS，用于管理工单、预防性维护、资产和设施。立即优化您的维护业务。',
  'overview.keywords': 'CMMS, 计算机化维护管理系统, EAM, 企业资产管理, 开源 CMMS, 免费维护软件, 工单管理, 预防性维护, 资产跟踪, 设施管理, 维护跟踪软件, 设备维护, SignalCare',
  'pricing.title': '价格 - SignalCare',
  'pricing.description': 'SignalCare 灵活的定价计划。在我们的开源 CMMS 的云端版本和自托管版本之间进行选择，以优化您的维护业务。',
