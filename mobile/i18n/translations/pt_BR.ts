const ptBRJSON = {
  ...
  home_description:
    'Quando quadros brancos e notas adesivas são uma bagunça, e você precisa de um software CMMS que seja fácil o suficiente para sua equipe realmente usar - experimente o SignalCare',
  try_grash: 'Experimente o SignalCare',
  login: 'Entrar',
  ...
  key_features_description:
    'Alguns dos recursos que tornam o SignalCare um dos melhores CMMS disponíveis hoje',
  ...
  'work-orders.descriptions.1':
    'Com o SignalCare, você pode organizar facilmente todas as suas ordens de serviço, PMs e outras tarefas em um banco de dados centralizado que pode ser acessado em qualquer dispositivo.',
  ...
  'work-requests.descriptions.1':
    'A solução de gerenciamento de manutenção do SignalCare permite que qualquer pessoa autorizada envie um problema para o departamento de manutenção simplesmente escaneando um código QR (código de barras) ou visitando uma URL e digitando sua solicitação através de seus dispositivos móveis.',
  ...
  'eam.descriptions.1':
    'O módulo de Gestão de Ativos Empresariais do SignalCare pode ser usado para entre 10 e 1.000.000 de ativos, permitindo que você rastreie exatamente o que deseja, da maneira que deseja, em uma estrutura de árvore fácil de usar e pesquisável.',
  'eam.checks.0':
  ...
  'pm.descriptions.1':
    'O SignalCare permite que você automatize facilmente o agendamento de PMs para que o trabalho certo seja entregue automaticamente no momento certo para o técnico certo no ativo certo.',
  'pm.checks.0':
  ...
  'part.descriptions.1':
    'Projetamos o gerenciamento de peças do SignalCare para resolver esses problemas e muito mais:',
  'part.checks.0':
  ...
  'dashboard.descriptions.1':
    'Com os Painéis Personalizados do SignalCare, você pode finalmente começar a entender o nefasto "buraco negro da manutenção" e começar a colocar planos baseados em dados em ação, resultando em redução de custos de mão de obra, diminuição do tempo de inatividade e muito mais.',
  'dashboard.descriptions.2':
    'Com os Painéis Personalizados do SignalCare, você poderá…',
  ...
  'dashboard.checks.4':
    'Visualize relatórios que são facilmente compartilhados via planilhas Excel, PDFs ou dentro do SignalCare',
  'dashboard.checks.5': 'E muito mais...',
  'home.smarter': 'Mais Inteligente',
  'home.work': 'Trabalho',
  'home.smarter_description':
    'O SignalCare torna incrivelmente fácil para os técnicos trabalharem com eficiência, dando-lhes acesso às ferramentas e dados de que precisam para realizar o trabalho — tudo na palma da mão.',
  leading_maintenance:
  ...
  no_labor:
    'Nenhum custo de mão de obra foi adicionado ainda. Eles aparecerão aqui quando um usuário registrar o tempo e tiver uma taxa horária armazenada no SignalCare.',
  ...
  create_role_description:
    'Esta função pode fazer tudo o que um Administrador pode fazer no SignalCare, mas você pode personalizar algumas permissões importantes abaixo.',
  ...
  number_users_who_will_use_grash: 'Número de usuários que usarão o SignalCare',
  admin_role: 'Admin',
  ...
  workflow_description:
    'Crie fluxos de trabalho personalizados tão fácil quanto Se, E, Então. Economize tempo e atribua facilmente suas ordens de serviço automaticamente por meio de fluxos de trabalho para personalizar o SignalCare para a maneira como sua equipe opera.\nTodos os planos podem criar até 1 fluxo de trabalho personalizado. Para adicionar fluxos de trabalho adicionais, atualize para nosso plano de Negócios',
  ...
  downgrade: 'Rebaixar',
  upgrade_description:
    'Você acabou de atualizar seu plano de assinatura. Você precisa habilitar os usuários desabilitados que podem usar o SignalCare. Você só pode fazer isso uma vez para a assinatura atual. Por favor, escolha com cuidado',
