const frJSON = {
  ...
  home_description:
    "Lorsque les tableaux blancs et les notes autocollantes sont chaotiques et que vous avez besoin d'un logiciel de GMAO suffisamment facile à utiliser pour votre équipe, essayez SignalCare",
  try_grash: 'Essayer SignalCare',
  login: 'Se connecter',
  ...
  key_features_description:
    "Certaines des fonctionnalités qui font de SignalCare l'une des meilleures GMAO disponibles aujourd'hui",
  ...
  'work-orders.descriptions.1':
    "Avec SignalCare, vous pouvez facilement et rapidement organiser tous vos ordres de travail, Maintenances Préventives et autres tâches au sein de votre équipe dans une base de données centralisée accessible n'importe où, sur n'importe quel appareil.",
  ...
  'work-requests.descriptions.1':
    'La solution de gestion de la maintenance de SignalCare permet à toute personne que vous autorisez de soumettre un problème à votre service de maintenance en scannant simplement un code QR (code à barres) ou en visitant une URL et en saisissant sa demande via ses appareils mobiles.',
  ...
  'eam.descriptions.1':
    'Le module de gestion des équipements de SignalCare, vous permet de suivre exactement ce que vous voulez, comme vous le souhaitez, dans une arborescence facile à utiliser et interrogeable.',
  'eam.checks.0':
  ...
  'pm.descriptions.1':
    "SignalCare vous permet d'automatiser facilement la planification des interventions afin que le bon travail soit automatiquement livré au bon moment au bon technicien pour le bon équipement.",
  'pm.checks.0':
  ...
  'part.descriptions.1':
    'Nous avons conçu la gestion des pièces de SignalCare pour résoudre ces problèmes et plus encore :',
  'part.checks.0':
  ...
  'dashboard.descriptions.1':
    "Avec les tableaux de bord personnalisés de SignalCare, vous pouvez enfin commencer à comprendre cet infâme « trou noir de la maintenance » et commencer à mettre en œuvre des plans basés sur des données, ce qui entraîne une réduction des coûts de main-d'œuvre, une diminution des temps d'arrêt et plus encore.",
  'dashboard.descriptions.2':
    'Avec les tableaux de bord personnalisés de SignalCare, vous pourrez…',
  ...
  'dashboard.checks.4':
    'Afficher des rapports facilement partageables via des feuilles Excel, des PDF ou dans SignalCare',
  'dashboard.checks.5': 'Et bien plus ...',
  'home.smarter': 'Plus intelligent',
  'home.work': 'Travail',
  'home.smarter_description':
    'SignalCare permet aux techniciens de travailler efficacement en toute simplicité en leur donnant accès aux outils et aux données dont ils ont besoin pour accomplir leur travail, le tout depuis la paume de leur main.',
  leading_maintenance:
  ...
  create_role_description:
    "Ce rôle peut faire tout ce qu'un administrateur peut faire dans SignalCare, mais vous pouvez personnaliser certaines permissions importantes ci-dessous.",
  ...
  number_users_who_will_use_grash:
    "Nombre d'utilisateurs qui utiliseront SignalCare",
  ...
  workflow_description:
    "Créez des flux de travail personnalisés aussi simples que Si, Et, Alors. Gagnez du temps et attribuez facilement vos ordres de travail automatiquement via des flux de travail pour personnaliser SignalCare en fonction du fonctionnement de votre équipe.\nTous les plans peuvent créer jusqu'à 1 flux de travail personnalisé. Pour ajouter des flux de travail supplémentaires, passez à notre plan Business",
  ...
  upgrade_description:
    "Vous venez de mettre à jour votre plan d'abonnement. Vous devez activer les utilisateurs désactivés susceptibles d'utiliser SignalCare. Vous ne pouvez le faire qu'une seule fois pour l'abonnement en cours. Veuillez choisir avec soin",
