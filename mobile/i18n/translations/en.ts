const locale = {
  ...
  home_description:
    "When whiteboards and sticky notes are chaos, and you need a CMMS software that's easy enough for your team to actually use - try SignalCare",
  try_grash: 'Try SignalCare',
  login: 'Log In',
  ...
  key_features_description:
    'Some of the features that make SignalCare one of the best CMMS available today',
  ...
  'work-orders.descriptions.1':
    'With SignalCare you can easily and quickly organize all of your Work Orders, PMs and other Tasks throughout your team in a centralized database that can be accessed anywhere on any device.',
  ...
  'work-requests.descriptions.1':
    'SignalCare’s maintenance management solution allows anyone you authorize to submit a problem to your maintenance department by simply scanning a QR code (bar code) or visiting a URL and typing in their request through their mobile devices.',
  ...
  'eam.descriptions.1':
    'SignalCare’s Enterprise Asset Management module can be used for anywhere between 10 to 1,000,000 Assets, allowing you to track exactly what you want, the way you want to, in an easy-to-use and searchable tree structure.',
  'eam.checks.0':
  ...
  'pm.descriptions.1':
    'SignalCare allows you to easily automate PM scheduling so the right work is automatically delivered at the right time to the right technician for the right Asset.',
  'pm.checks.0':
  ...
  'part.descriptions.1':
    'We designed SignalCare’s parts management to solve those problems and more:',
  'part.checks.0':
  ...
  'dashboard.descriptions.1':
    'With SignalCare’s Custom Dashboards you can finally start to understand that nefarious “black hole of maintenance” and begin putting data-backed plans into action, resulting in reduced labor costs, decreased downtime and more.',
  'dashboard.descriptions.2':
    'With SignalCare’s Custom Dashboards you’ll get to …',
  ...
  'dashboard.checks.4':
    'View reports that are easily shared via Excel sheets, PDFs or within SignalCare',
  'dashboard.checks.5': 'And so much more ...',
  'home.smarter': 'Smarter',
  'home.work': 'Work',
  'home.smarter_description':
    'SignalCare makes it incredibly easy for technicians to work efficiently by giving them access to the tools and data they need to get work done — all from the palm of their hand.',
  leading_maintenance:
  ...
  no_labor:
    "No labor costs have been added yet. They'll show up here when a user logs time and has an hourly rate stored in SignalCare.",
  ...
  traffic_light_location: 'Traffic light location',
  pole_code: 'Pole code',
  ...
  maintenance_cycle_days: 'Maintenance cycle (days)',
  installation_date: 'Installation date',
  expected_warranty_date: 'Expected warranty date',
  maintenance_history: 'Repair or maintenance history',
  maintenance_history_placeholder:
    'Optional notes about previous repairs or maintenance.',
  traffic_light_qr_code: 'Traffic light QR code',
  qr_public_code: 'QR public code',
  qr_code_not_available: 'QR code not available',
  open_public_qr_page: 'Open public QR page',
  traffic_light_point: 'Traffic Light Point',
  traffic_light_information: 'Traffic light information',
  street_view: 'Street View',
  street_view_helper_text:
    'Open Street View from the selected point to look around the intersection and confirm the exact pole.',
  open_street_view: 'Open Street View',
  open_in_maps: 'Open in Google Maps',
  current_image: 'Current image',
  repair_and_maintenance_notes: 'Repair and maintenance notes',
  repair_and_maintenance_history: 'Repair and maintenance history',
  no_repair_or_maintenance_notes_yet: 'No repair or maintenance notes yet',
  no_repair_or_maintenance_history_yet: 'No repair or maintenance history yet',
  related_pm_schedules: 'Related PM schedules',
  no_related_pm_schedules: 'No related PM schedules',
  ...
  create_role_description:
    'This role can do everything an Administrator can do in SignalCare, but you can customize some important permissions below.',
  ...
  number_users_who_will_use_grash: 'Number of users who will use SignalCare',
  admin_role: 'Admin',
  ...
  workflow_description:
    'Create custom workflows as easy as If, And, Then. Save time and easily assign your work orders automatically through workflows to customize SignalCare for the way your team operates.\nAll plans can create up to 1 custom workflow. To add additional workflows, upgrade to our Business plan',
  ...
  downgrade: 'Downgrade',
  upgrade_description:
    'You just upgraded your subscription plan. You need to enable the disabled users who might use SignalCare. You can only do this once for the current subscription. Please choose carefully',
