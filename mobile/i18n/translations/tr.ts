const trJSON = {
  ...
  home_description:
    "Beyaz tahtalar ve yapışkan notlar kaosa dönüştüğünde ve ekibinizin gerçekten kullanabileceği kadar kolay bir CMMS yazılımına ihtiyaç duyduğunuzda SignalCare'ı deneyin",
  try_grash: "SignalCare'ı deneyin",
  login: 'Giriş',
  ...
  key_features_description:
    "SignalCare'ı günümüzün en iyi CMMS'lerinden biri yapan özelliklerden bazıları",
  ...
  'work-orders.descriptions.1':
    "SignalCare ile ekibinizdeki tüm İş Emirlerinizi, PM'lerinizi ve diğer Görevlerinizi, herhangi bir cihazdan herhangi bir yerden erişilebilen merkezi bir veritabanında kolayca ve hızlı bir şekilde düzenleyebilirsiniz.",
  ...
  'work-requests.descriptions.1':
    "SignalCare'ın bakım yönetimi çözümü, yetkilendirdiğiniz herkesin, yalnızca bir QR kodunu (barkod) tarayarak veya bir URL'yi ziyaret edip mobil cihazları aracılığıyla isteklerini yazarak bakım departmanınıza sorun göndermesine olanak tanır.",
  ...
  'eam.descriptions.1':
    "SignalCare'nin Kurumsal Varlık Yönetimi modülü, 10 ila 1.000.000 Varlık arasında herhangi bir yerde kullanılabilir ve kullanımı kolay ve aranabilir bir ağaç yapısında tam olarak ne istediğinizi, istediğiniz şekilde izlemenize olanak tanır.",
  'eam.checks.0':
  ...
  'pm.descriptions.1':
    'SignalCare, PM planlamasını kolaylıkla otomatikleştirmenize olanak tanır; böylece doğru iş, doğru Varlık için doğru zamanda, doğru teknisyene otomatik olarak teslim edilir.',
  'pm.checks.0':
  ...
  'part.descriptions.1':
    "SignalCare'ın parça yönetimini bu sorunları ve daha fazlasını çözmek için tasarladık:",
  'part.checks.0':
  ...
  'dashboard.descriptions.1':
    'SignalCare\'ın Özel Kontrol Panelleri ile nihayet bu kötü niyetli "bakım kara deliğini" anlamaya başlayabilir ve veri destekli planları eyleme geçirmeye başlayabilirsiniz, bu da işçilik maliyetlerinin azalmasına, arıza sürelerinin azalmasına ve daha fazlasına yol açabilir.',
  'dashboard.descriptions.2':
    "SignalCare'ın Özel Kontrol Panelleri ile şunları elde edeceksiniz:",
  ...
  'dashboard.checks.4':
    "Excel sayfaları, PDF'ler veya SignalCare aracılığıyla kolayca paylaşılan raporları görüntüleyin",
  'dashboard.checks.5': 'Ve çok daha fazlası...',
  'home.smarter': 'Daha akıllı',
  'home.work': 'İş',
  'home.smarter_description':
    'SignalCare, teknisyenlerin işlerini yapmak için ihtiyaç duydukları araçlara ve verilere avuçlarının içinden erişmelerini sağlayarak verimli çalışmalarını inanılmaz derecede kolaylaştırıyor.',
  leading_maintenance:
  ...
  create_role_description:
    "Bu rol, bir Yöneticinin SignalCare'ta yapabileceği her şeyi yapabilir ancak bazı önemli izinleri aşağıda özelleştirebilirsiniz.",
  ...
  number_users_who_will_use_grash: "SignalCare'ı kullanacak kullanıcı sayısı",
  admin_role: 'Yönetici',
